...
class AccurateController extends Controller
{
    ...
    public function redirect(Website $website)
    {
        ...
        $url = "https://account.accurate.id/oauth/authorize?client_id={$clientId}&response_type=code&redirect_uri={$redirectUri}&scope=item_view item_save sales_invoice_save item_adjustment_save sales_receipt_save customer_save&state={$state}";
