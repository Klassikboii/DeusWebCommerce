                    ...
                    <div class="card card-website h-100 p-3 bg-white rounded-3 shadow-sm">
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            ...
                            <div>
                                ...
                                <a href="{{ $website->store_url }}" target="_blank" class="text-decoration-none small text-muted">
                        ...
                        <div class="mt-auto pt-3 border-top d-flex gap-2">
                            <a href="{{ $website->store_url }}" target="_blank" class="btn btn-light flex-fill border btn-sm py-2">
